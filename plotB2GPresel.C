...

{
  ...
  string outputDir("B2GPreselPlots");
  ...
  samplev.back()->fnamev.push_back("../baconbits/SingleElectron_2012-22Jan2013_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/SingleMu_2012-22Jan2013_semileptb2gbits.root");
           
  // dibosons
  samplev.push_back(new CSample("diboson",kRed-6,kRed+2));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_WW_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_WZJetsTo3LNu_TuneZ2_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_WZJetsTo2L2Q_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_WZJetsTo2QLNu_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_ZZJetsTo2Q2Nu_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_ZZJetsTo2L2Q_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_ZZJetsTo2L2Nu_TuneZ2star_semileptb2gbits.root");
                                  
  // Z+jets
  samplev.push_back(new CSample("Z+jets",kOrange-2,kOrange-3));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_DY0JetsToLL_M-50_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_DY1JetsToLL_M-50_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_DY2JetsToLL_M-50_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_DY3JetsToLL_M-50_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_DY4JetsToLL_M-50_TuneZ2Star_semileptb2gbits.root");
                                                             
  // single top
  samplev.push_back(new CSample("single t",kAzure-8,kBlue-6));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_T_tW-channel-DR_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_Tbar_tW-channel-DR_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_T_s-channel_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_Tbar_s-channel_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_T_t-channel_TuneZ2star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_Tbar_t-channel_TuneZ2star_semileptb2gbits.root");

  // W+jets
  samplev.push_back(new CSample("W+jets",kOrange+7,kOrange+10));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_W0JetsToLNu_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_W1JetsToLNu_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_W2JetsToLNu_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_W3JetsToLNu_TuneZ2Star_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_W4JetsToLNu_TuneZ2Star_semileptb2gbits.root");
                                                                               
  // ttbar
  samplev.push_back(new CSample("t#bar{t}",kGreen+2,kGreen+3));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTJets_FullLeptMGDecays_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTJets_SemiLeptMGDecays_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTJets_HadronicMGDecays_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTGJets_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTWJets_semileptb2gbits.root");
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTZJets_semileptb2gbits.root");

  // DM
  samplev.push_back(new CSample("DM 1 GeV",kMagenta+2,kMagenta+3));
  samplev.back()->fnamev.push_back("../baconbits/Summer12_TTChiChiJets_M-1_TuneZ2star_semileptb2gbits.root");
  ...
  TLorentzVector *jet1=0, *jet2=0;               // jet 4-vector
  ...
  for(unsigned int isam=0; isam<samplev.size(); isam++) {
    ...
    for(unsigned int ifile=0; ifile<sample->fnamev.size(); ifile++) {
      ...
      for(unsigned int ientry=0; ientry<intree->GetEntries(); ientry++) {
        ...
        double dphi = TMath::Min(fabs(deltaPhi(jet1->Phi(),pfmetphi)),fabs(deltaPhi(jet2->Phi(),pfmetphi)));
        ...
        hJet1Etav[ilep][isam]->Fill(jet1->Eta(), weight);
        hJet2Etav[ilep][isam]->Fill(jet2->Eta(), weight);
        ...
        hJet1Etav[2][isam]->Fill(jet1->Eta(), weight);
        hJet2Etav[2][isam]->Fill(jet2->Eta(), weight);
        ...
        if(!isData && !isSignal) {
          ...
          hJet1EtaMC[ilep]->Fill(jet1->Eta(), weight);
          hJet2EtaMC[ilep]->Fill(jet2->Eta(), weight);
          ...
          hJet1EtaMC[2]->Fill(jet1->Eta(), weight);
          hJet2EtaMC[2]->Fill(jet2->Eta(), weight);
